...
/**
 * UserResourceLastPulse Class Doc Comment
 *
 * @category Class
 * @package  WhatPulse
 * @author   OpenAPI Generator team
 ...
 */
class UserResourceLastPulse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserResource_last_pulse';
    ...
    */
     ...
     * Sets date
     *
     * @param string $date The date of the last pulse, in ISO 8601 format.
     *
     * @return self
     */
     ...
     * Sets keys
     *
     * @param int $keys The number of keys pressed in the last pulse.
     *
     * @return self
     */
     ...
     * Sets clicks
     *
     * @param int $clicks The number of mouse clicks in the last pulse.
     *
     * @return self
     */
     ...
     * Sets download_mb
     *
     * @param float $download_mb The amount of data downloaded in the last pulse, in megabytes.
     *
     * @return self
     */
     ...
     * Sets upload_mb
     *
     * @param float $upload_mb The amount of data uploaded in the last pulse, in megabytes.
     *
     * @return self
     */
     ...
     * Sets uptime_seconds
     *
     * @param int $uptime_seconds The uptime recorded in the last pulse, in seconds.
     *
     * @return self
     */
     ...
     * Sets scrolls
     *
     * @param int $scrolls The number of mouse scrolls recorded in the last pulse.
     *
     * @return self
     */
     ...
     * Sets distance_miles
     *
     * @param float $distance_miles The distance the mouse has moved in miles during the last pulse.
     *
     * @return self
     */
