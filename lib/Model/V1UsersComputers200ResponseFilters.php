...
/**
 * V1UsersComputers200ResponseFilters Class Doc Comment
 *
 * @category Class
 * @package  WhatPulse
 * @author   OpenAPI Generator team
 ...
 */
class V1UsersComputers200ResponseFilters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1_users_computers_200_response_filters';
    ...
    */
    ...
    public function setIsArchived($is_archived)
    {
        if (is_null($is_archived)) {
            array_push($this->openAPINullablesSetToNull, 'is_archived');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_archived', $nullablesSetToNull);
            if ($index !== FALSE) {
