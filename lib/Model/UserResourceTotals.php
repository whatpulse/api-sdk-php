...
/**
 * UserResourceTotals Class Doc Comment
 *
 * @category Class
 * @package  WhatPulse
 * @author   OpenAPI Generator team
 ...
 */
class UserResourceTotals implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserResource_totals';
    ...
    */
     ...
     * Sets keys
     *
     * @param int $keys The total number of keys pressed by the user.
     *
     * @return self
     */
     ...
     * Sets clicks
     *
     * @param int $clicks The total number of mouse clicks made by the user.
     *
     * @return self
     */
     ...
     * Sets download_mb
     *
     * @param float $download_mb The total amount of data downloaded by the user, in megabytes.
     *
     * @return self
     */
     ...
     * Sets upload_mb
     *
     * @param float $upload_mb The total amount of data uploaded by the user, in megabytes.
     *
     * @return self
     */
     ...
     * Sets uptime_seconds
     *
     * @param int $uptime_seconds The total uptime the user has recorded, in seconds.
     *
     * @return self
     */
     ...
     * Sets scrolls
     *
     * @param int $scrolls The total number of mouse scrolls recorded for the user.
     *
     * @return self
     */
