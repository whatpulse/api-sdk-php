...
/**
 * UserResourceRanks Class Doc Comment
 *
 * @category Class
 * @package  WhatPulse
 * @author   OpenAPI Generator team
 ...
 */
class UserResourceRanks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserResource_ranks';
    ...
    */
     ...
     * Sets keys
     *
     * @param int $keys The user's rank based on the total number of keys pressed.
     *
     * @return self
     */
     ...
     * Sets clicks
     *
     * @param int $clicks The user's rank based on the total number of mouse clicks.
     *
     * @return self
     */
     ...
     * Sets download
     *
     * @param int $download The user's rank based on the total amount of data downloaded, in megabytes.
     *
     * @return self
     */
     ...
     * Sets upload
     *
     * @param int $upload The user's rank based on the total amount of data uploaded, in megabytes.
     *
     * @return self
     */
     ...
     * Sets uptime
     *
     * @param int $uptime The user's rank based on the total uptime recorded, in seconds.
     *
     * @return self
     */
     ...
     * Sets scrolls
     *
     * @param int $scrolls The user's rank based on the total number of mouse scrolls.
     *
     * @return self
     */
     ...
     * Sets distance
     *
     * @param int $distance The user's rank based on the total distance the mouse has moved in miles.
     *
     * @return self
     */
