...
/**
 * LinksResource Class Doc Comment
 *
 * @category Class
 * @package  WhatPulse
 * @author   OpenAPI Generator team
 ...
 */
class LinksResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinksResource';
    ...
    */
     ...
     * Sets first
     *
     * @param string $first The URL for the first page of results.
     *
     * @return self
     */
     ...
     * Sets last
     *
     * @param string $last The URL for the last page of results.
     *
     * @return self
     */
     ...
     * Sets prev
     *
     * @param string $prev The URL for the previous page of results, or null if there is no previous page.
     *
     * @return self
     */
     ...
     * Sets next
     *
     * @param string $next The URL for the next page of results, or null if there is no next page. If you're paginating, you can call this url to get the next page of results.
     *
     * @return self
     */
